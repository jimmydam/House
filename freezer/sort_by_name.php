...
<?php
	...
	if(!empty($_SESSION['currrentUser'])){
		...
		// sql SELECT command
		$command = "SELECT  ID, name, type, description, date FROM freezer ORDER BY name;";
			...
			if($_SESSION['logged_in']){
				...
				echo "
					...
					<form class='form' action='insert.php' method='POST'>
						...
						<label class='update'>Type:</label> <input type='text'  class='input' name='type' value='NULL'><br>
